  ...
  return (
    <>
      <div className="">
        <button
          onClick={handleClick}
          className="rounded-full cursor-pointer p-3 bg-(--theme-grey)"
        >
          {children}
        </button>
      </div>
      {openDialog && (
        <div className="shadow-[0_6px_20px_0_rgba(0,0,0,0.1)] rounded-[20px] bg-white py-3 fixed border-(--colour-border) top-[70px] w-[260px] right-12">
          <Link href="#" className="block px-6 py-2 hover:bg-(--theme-grey)">
            Help Center
          </Link>
          ...
          >
            <div className="border-y-(--colour-border) w-[70%]">
              ...
              <p className="text-xs">
                It&apos;s easy to start hosting and earn an extra income
              </p>
            </div>
            <div className="w-[30%]">
              <Image
