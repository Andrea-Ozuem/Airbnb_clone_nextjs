    ...
    return (
            ...
            >
                    <div className="py-3 px-6">
                        <span className="font-semibold block text-xs">Where</span>
                        <input type="search" name="" id="" placeholder="Search destinations"/>
                    </div>
                    <div className="bg-(--colour-border) h-[32px] w-[1px]"></div>

                    <div className="py-3 px-6">
                        <span className="font-semibold block text-xs">Check in</span>
                    ...
                    <div className="py-3 px-6 flex items-center justify-between">
                        <div>
                        <span className="font-semibold block text-xs">Who</span>
