      ...
      <div className="flex flex-col">
        ...
        >
          <div className="flex justify-between gap-[8px] items-start">
            {item.guestFavorite ? (
              <div className="text-xs bg-[rgba(255,255,255,0.8)] px-[8px] py-[4px] rounded-[14px] border border-[rgba(255,255,255,0.5)] font-semibold leading-4">
                Guest favorite
              </div>
            ) : (
              <div></div>
        ...
        <div>
          <p className="text-[12px]">
            ${item.price} for {item.nights} nights <span>{item.rating}</span>
          </p>
        </div>
      </div>
    </li>
